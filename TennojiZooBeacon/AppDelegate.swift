...
//    let answer1 = ["none","","","","オスの仕事","サニー花子","たったまま寝る","肌色","",]//余り0　黄
    ...
    let answer2 = ["gate1","ユーカリ","　要再考　","喜ぶ","オスとメス両方","40〜50年","木登り","肝臓","100cmぐらい","茶色","5本","手のひらで歩く","gate2","貝類","歯","内蔵","木をつつく","くちばし","筋肉","卵を見つけると、岩にぶつけて割る","1.3m〜1.5m","パック","青色","巣な取り猫","メスの方が大きい","シベリアトラ","小さい","お腹を地面にすりながら歩くから","クラスタリング","3本","5個","脂肪"]
