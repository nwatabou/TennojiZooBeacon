...
class AppDelegate: UIResponder, UIApplicationDelegate, CLLocationManagerDelegate {
    ...
    let animals = ["てんしば入口","ヴィクトリアコアラ","フサオネズミカンガルー","ホオアカトキ","シシオザル","タイゾウ","メガネグマ","ホッキョクグマ","シロフクロウ","コサンケイ","カリフォルニアアシカ","チンパンジー","新世界入り口","ヨウスコウワニ","コイ","シリケンイモリ","チリーフラミンゴ","ソデグロヅル","ヒガシクロサイ","コビトマングース","アミメキリン","ライオン","セーカーハヤブサ","スナドリネコ","ムフロン","アムールトラ","チュウゴクオオカミ","シセンレッサーパンダ","ニホンコウノトリ","フンボルトペンギン","ヒツジ","フタコブラクダ"]
//    let animals = ["error","","","","ライオン","タイゾウ","アミメキリン","アムールトラ","ヒガシクロサイ","ホッキョクグマ"]
    
    //図鑑表示用のID
    let url = ["gate1","1151","1153","2907","1260","1502","1405","1407","2934","2558","1451","1267","gate2","3152","5904","4902","2403","2606","1922","1415","1606","1425","2921","1420","1613","1422","1403","1914","2356","2254","1927","1603"]
    
    
    let message = ["てんしば入口","森にたたずむおっとりや","ネズミだけどネズミじゃない！？","見た目は魔女","その先に王のたてがみ","鼻の長〜い動物","大きいメガネ","白き巨体","寒くてもへっちゃら","真っ赤なお顔","海のライオン","人間そっくり！？","新世界入口","笑顔が得意技","ダンディーなヒゲ","可愛い顔して毒がある","美しい足","実は真っ白じゃない？","「クロ」だけど「黒」じゃない","小さくたって肉食系","首を長〜くして待ってます","たたずむは獣の王者","りりしい顔立ち","魚が好物","もふもふでゴツゴツ！？","大阪のおばちゃんも愛用？","日本ではここしか居ない！？","たぬき？くま？","大人になると鳴かなくなる鳥！？","意外とあたたかいところが好き","ふわふわお布団","砂漠の船"]
//    let message = ["none","","","","百獣の王","鼻の長い動物","陸上で最も背の高い動物","大阪のおばちゃん愛用","鎧のような体","白き巨体"]
    
    let quiz = ["","エサとして食べないのは？","移動方法は？","恋人がなくなるとどうする？","顔にたてがみがあるのはオス？メス？","寿命はどれぐらい？","上手な運動は？","実はある部分に毒を持っています。どこでしょう？","翼を広げると何cm？","オスの羽の色は？","指は何本でしょう？","チンパンジーの歩き方は？","gate2","主な食べ物は？","コイにないものは？","どこに毒があるでしょう？","エサの食べ方は？","黒い部分はどこでしょう？","ツノは何でできているかな？","コビトマングースの習性として正しいものは？","アミメキリンの子どもの大きさはどれぐらい？","群のことをなんというかな？","鼻の色は何色？","漢字ではどう書くかな？","ツノはオスとメスどっちの方が大きい？","別名は？","狼の中ではどれくらいの大きさかな？","お腹が黒い理由は？","くちばしを使って仲間に合図を送ることをなんという？","胸にある黒い帯は何本？","羊のツメは何個にわかれている？","コブはなにでできている？"]
//    let quiz = ["none","","","","狩りをするのは？","天王寺動物園で飼われているゾウの名前は？","キリンはどうやって寝るでしょう？","トラの肌は何色でしょう？","",""]
    
    
    let answer1 = ["gate1","クスノキ","人間みたいに2本足で歩く","悲しむ","オス","10〜20年","木登り","口の中","30cmぐらい","青色","6本","足で歩く","gate2","人間","うろこ","皮膚の表面","泥ごと口に含む","首","毛","100匹以上の群で行動する","1m〜1.2m","プライド","赤色","砂取り猫","オスの方が大きい","ベンガルトラ","大きい","敵に見つけられにくいように","クライミング","2本","2個","骨"]
    //問題の答えは、配列番号を3で割った余りのanswer番号
//    let answer1 = ["none","","","","オスの仕事","サニー花子","たったまま寝る","肌色","",]//余り0　黄
    
    let answer2 = ["gate1","ユーカリ","両足で跳んで歩く","喜ぶ","オスとメス両方","40〜50年","ダンス","肝臓","100cmぐらい","茶色","5本","手のひらで歩く","gate2","貝類","歯","内蔵","木をつつく","くちばし","筋肉","卵を見つけると、岩にぶつけて割る","1.3m〜1.5m","パック","青色","巣な取り猫","メスの方が大きい","シベリアトラ","小さい","お腹を地面にすりながら歩くから","クラッタリング","3本","5個","脂肪"]
//    let answer2 = ["none","","","","メスの仕事","エレファント陽子","横になって寝る","黒色","",]//余り1　青
    
    let answer3 = ["gate1","タンポポ","手と足を使って歩く","怒る","メスだけ","70〜80年","ジャンプ","胃","140cmよりも長い","灰色","4本","手の甲をついて歩く","gate2","干し草","胃","舌","食べない","羽の先端","骨","ヘビを襲って食べてしまう","1.6m〜1.8mぐらい","タワー","黄色","漁り猫","オスもメスも同じくらい","スマトラトラ","中くらい","お腹を洗わないから","クローリング","いやいや、1本でしょ","3個","筋肉"]
